...
import com.plcoding.cryptotracker.crypto.data.mappres.toCoin
import com.plcoding.cryptotracker.crypto.data.mappres.toCoinPrice
...
class RemoteCoinDataSource(
    ...
    override suspend fun getCoinHistory(
        ...
        val startMillis = start
            .withZoneSameInstant(ZoneId.of("Africa/Cairo"))
            .toInstant()
            .toEpochMilli()
        val endMillis = end
            .withZoneSameInstant(ZoneId.of("Africa/Cairo"))
